...
// V3.1: AMD Vulkan Memory Allocator (Official)
// Replaces the broken Micro-VMA that was losing offsets and corrupting memory.
// ÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚Â
...
#endif
#include "include/bcn_decoder/bcn_decoder.h"
...
VkFormat exynos_layer_replacement_format(VkFormat format) {
    // View format exposed back to the application.
    switch (format) {
        case VK_FORMAT_BC1_RGB_UNORM_BLOCK:
        case VK_FORMAT_BC1_RGBA_UNORM_BLOCK:
        case VK_FORMAT_BC2_UNORM_BLOCK:
...
static VkFormat exynos_layer_storage_format(VkFormat format) {
    // Actual image format used for image creation / storage-image writes.
    switch (format) {
        case VK_FORMAT_BC1_RGB_UNORM_BLOCK:
        case VK_FORMAT_BC1_RGB_SRGB_BLOCK:
        case VK_FORMAT_BC1_RGBA_UNORM_BLOCK:
...
static TargetDeviceFuncs g_device_funcs = {};
static std::unordered_map<VkDeviceMemory, VmaAllocation> g_vma_allocations;
static std::mutex g_vma_allocations_mutex;
...
static bcn::BcnDecoderContext* g_decoder_context = nullptr;
static bool g_image_map_initialized = false;
static bool g_bcn_decode_enabled = false;
...
static uint32_t pick_decoder_queue_family(VkPhysicalDevice physicalDevice,
    ...
    if (!props_fn) {
        return pCreateInfo->pQueueCreateInfos[0].queueFamilyIndex;
    }

    uint32_t queueFamilyCount = 0;
    props_fn(physicalDevice, &queueFamilyCount, nullptr);
    if (queueFamilyCount == 0) {
        return UINT32_MAX;
    }

    std::vector<VkQueueFamilyProperties> queueFamilies(queueFamilyCount);
    props_fn(physicalDevice, &queueFamilyCount, queueFamilies.data());

    uint32_t fallbackFamily = UINT32_MAX;
    for (uint32_t i = 0; i < pCreateInfo->queueCreateInfoCount; ++i) {
        const uint32_t family = pCreateInfo->pQueueCreateInfos[i].queueFamilyIndex;
        if (family >= queueFamilyCount || pCreateInfo->pQueueCreateInfos[i].queueCount == 0) {
            continue;
        }

        const VkQueueFlags flags = queueFamilies[family].queueFlags;
        if ((flags & VK_QUEUE_COMPUTE_BIT) && (flags & VK_QUEUE_GRAPHICS_BIT)) {
            return family;
        }
        if ((flags & VK_QUEUE_COMPUTE_BIT) && fallbackFamily == UINT32_MAX) {
            fallbackFamily = family;
        } else if (fallbackFamily == UINT32_MAX) {
            fallbackFamily = family;
        }
    }
...
static bool init_decoder_context(VkPhysicalDevice physicalDevice,
                                 VkDevice device,
                                 const VkDeviceCreateInfo* pCreateInfo) {
    if (g_decoder_context) {
        return true;
    }

    const uint32_t queueFamily = pick_decoder_queue_family(physicalDevice, pCreateInfo);
    if (queueFamily == UINT32_MAX) {
        LOGW("BCn decoder context skipped: no usable queue family found");
        return false;
    }

    auto get_queue_fn = reinterpret_cast<PFN_vkGetDeviceQueue>(real_gdpa(device, "vkGetDeviceQueue"));
    if (!get_queue_fn) {
        LOGW("BCn decoder context skipped: vkGetDeviceQueue unavailable");
        return false;
    }

    VkQueue queue = VK_NULL_HANDLE;
    get_queue_fn(device, queueFamily, 0, &queue);
    if (queue == VK_NULL_HANDLE) {
        LOGW("BCn decoder context skipped: no queue handle for family %u", queueFamily);
        return false;
    }

    bcn::DecoderCreateInfo createInfo{};
    createInfo.instance = g_instance;
    createInfo.physicalDevice = physicalDevice;
    createInfo.device = device;
    createInfo.computeQueue = queue;
    createInfo.computeQueueFamily = queueFamily;

    bcn::BcnDecoderContext* context = nullptr;
    const bcn::BcnResult result = bcn::BcnDecoderContext::create(createInfo, &context);
    if (result != bcn::BcnResult::Success || !context) {
        LOGW("BCn decoder context init failed: %s", bcn::resultToString(result));
        return false;
    }

    g_decoder_context = context;
    LOGI("BCn decoder context online on queue family %u", queueFamily);
    return true;
}

static void shutdown_decoder_context() {
    if (g_decoder_context) {
        g_decoder_context->destroy();
        g_decoder_context = nullptr;
    }
}

static bool try_decode_bcn_copy(VkCommandBuffer commandBuffer,
                                VkBuffer srcBuffer,
                                VkImage dstImage,
                                VkImageLayout dstImageLayout,
                                uint32_t regionCount,
                                const VkBufferImageCopy* pRegions) {
    if (!g_bcn_decode_enabled || !g_image_map_initialized || !pRegions || regionCount == 0) {
        return false;
    }

    BCnImageInfo imageInfo{};
    if (!exynos_imap_get(&g_image_map, dstImage, &imageInfo) || !imageInfo.is_bcn) {
        return false;
    }

    if (!g_decoder_context) {
        LOGE("BCn image copy intercepted without a live decoder context; skipping unsafe raw copy");
        return true;
    }

    bcn::BufferImageDecodeInfo decodeInfo{};
    decodeInfo.commandBuffer = commandBuffer;
    decodeInfo.srcBuffer = srcBuffer;
    decodeInfo.dstImage = dstImage;
    decodeInfo.sourceFormat = imageInfo.original_format;
    decodeInfo.destinationFormat = imageInfo.storage_format != VK_FORMAT_UNDEFINED
        ? imageInfo.storage_format
        : imageInfo.replacement_format;
    decodeInfo.currentLayout = dstImageLayout;
    decodeInfo.finalLayout = dstImageLayout;
    decodeInfo.regionCount = regionCount;
    decodeInfo.pRegions = pRegions;

    const bcn::BcnResult result = g_decoder_context->recordDecodeBufferToImage(decodeInfo);
    if (result != bcn::BcnResult::Success) {
        LOGE("BCn inline decode failed for format %d: %s",
             static_cast<int>(imageInfo.original_format),
             bcn::resultToString(result));
        return true;
    }
...
static VKAPI_ATTR VkResult VKAPI_CALL hook_vkEnumerateDeviceExtensionProperties(
    ...
    if (!pProperties) {
        // Caller just wants the count ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â add our injected extensions
...
static VKAPI_ATTR VkResult VKAPI_CALL hook_vkCreateDevice(
    ...
    if (result == VK_SUCCESS && pDevice && *pDevice != VK_NULL_HANDLE) {
        ...
        g_device_funcs.vkCreateImage = reinterpret_cast<PFN_vkCreateImage>(
            real_gdpa(*pDevice, "vkCreateImage"));
        g_device_funcs.vkDestroyImage = reinterpret_cast<PFN_vkDestroyImage>(
            real_gdpa(*pDevice, "vkDestroyImage"));
        g_device_funcs.vkGetImageMemoryRequirements = reinterpret_cast<PFN_vkGetImageMemoryRequirements>(
            real_gdpa(*pDevice, "vkGetImageMemoryRequirements"));
        g_device_funcs.vkBindImageMemory = reinterpret_cast<PFN_vkBindImageMemory>(
            real_gdpa(*pDevice, "vkBindImageMemory"));
        g_device_funcs.vkCreateImageView = reinterpret_cast<PFN_vkCreateImageView>(
            real_gdpa(*pDevice, "vkCreateImageView"));
        g_device_funcs.vkAllocateMemory = reinterpret_cast<PFN_vkAllocateMemory>(
            real_gdpa(*pDevice, "vkAllocateMemory"));
        g_device_funcs.vkFreeMemory = reinterpret_cast<PFN_vkFreeMemory>(
            real_gdpa(*pDevice, "vkFreeMemory"));
        g_device_funcs.vkQueueSubmit = reinterpret_cast<PFN_vkQueueSubmit>(
            real_gdpa(*pDevice, "vkQueueSubmit"));
        g_device_funcs.vkWaitForFences = reinterpret_cast<PFN_vkWaitForFences>(
            real_gdpa(*pDevice, "vkWaitForFences"));
        g_device_funcs.vkCreateShaderModule = reinterpret_cast<PFN_vkCreateShaderModule>(
            real_gdpa(*pDevice, "vkCreateShaderModule"));
        g_device_funcs.vkCmdCopyBufferToImage = reinterpret_cast<PFN_vkCmdCopyBufferToImage>(
            real_gdpa(*pDevice, "vkCmdCopyBufferToImage"));
        g_device_funcs.vkCmdCopyBufferToImage2 = reinterpret_cast<PFN_vkCmdCopyBufferToImage2>(
            real_gdpa(*pDevice, "vkCmdCopyBufferToImage2"));
#ifdef VK_KHR_copy_commands2
        g_device_funcs.vkCmdCopyBufferToImage2KHR = reinterpret_cast<PFN_vkCmdCopyBufferToImage2KHR>(
            real_gdpa(*pDevice, "vkCmdCopyBufferToImage2KHR"));
#endif
        g_device_funcs.vkCmdDraw = reinterpret_cast<PFN_vkCmdDraw>(
            real_gdpa(*pDevice, "vkCmdDraw"));
        g_device_funcs.vkDestroyDevice = reinterpret_cast<PFN_vkDestroyDevice>(
            real_gdpa(*pDevice, "vkDestroyDevice"));
        
        // Initialize BCn decoding pipeline!
        pthread_mutex_lock(&g_layer_lock);
        if (!g_image_map_initialized) {
            exynos_imap_init(&g_image_map, 1024);
            g_image_map_initialized = true;
            LOGI("BCn Image Map initialized (V3.1 - C dispatcher removed)");
        }
        
        // ÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚Â
        // V3.1 Module Initialization (Watchdog, Micro-VMA, SPIR-V Patcher REMOVED)
        // ÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚ÂÃƒÂ¢Ã¢â‚¬Â¢Ã‚Â
        if (!g_v16_modules_init) {
            // 1) Dynamic Config ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â load user .ini
            exynos_config_auto_load(&g_config);
            LOGI("V3.1 Config: bcn=%d mipmap=%d pcache=%d wg=%u",
                 g_config.enable_bcn_decode,
                 g_config.enable_mipmap,
                 g_config.enable_pipeline_cache,
                 g_config.workgroup_size);

            // 2) Pipeline Cache ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â eliminates shader stutter
            ...
            // 3) AMD VMA Ã¢â‚¬â€ Official Vulkan Memory Allocator
            {
                VmaVulkanFunctions vma_funcs = {};
                vma_funcs.vkGetInstanceProcAddr = g_real_vkGetInstanceProcAddr;
                vma_funcs.vkGetDeviceProcAddr = g_real_vkGetDeviceProcAddr;

                VmaAllocatorCreateInfo vma_ci = {};
                vma_ci.flags = VMA_ALLOCATOR_CREATE_EXTERNALLY_SYNCHRONIZED_BIT |
                               VMA_ALLOCATOR_CREATE_BUFFER_DEVICE_ADDRESS_BIT;
                vma_ci.physicalDevice = physicalDevice;
                vma_ci.device = *pDevice;
                vma_ci.instance = g_instance;
                vma_ci.pVulkanFunctions = &vma_funcs;
                vma_ci.vulkanApiVersion = VK_API_VERSION_1_1;

                VkResult vma_res = vmaCreateAllocator(&vma_ci, &g_vma_allocator);
                if (vma_res == VK_SUCCESS) {
                    LOGI("AMD VMA V3.1 ONLINE (Official Vulkan Memory Allocator)");
                } else {
                    LOGW("AMD VMA init failed (res=%d), falling through to native alloc", (int)vma_res);
                    g_vma_allocator = VK_NULL_HANDLE;
                }
            }

            // 4) Transform Feedback Software Emulator
            exynos_tfb_init(&g_tfb_emulator, *pDevice);
            LOGI("Transform Feedback Emulator V3.1 ONLINE");

            g_v16_modules_init = true;
            LOGI("ExynosTools V3.1 (Granite Edition) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â ALL MODULES INITIALIZED");
        }
        g_bcn_decode_enabled = g_config.enable_bcn_decode &&
                               init_decoder_context(physicalDevice, *pDevice, pCreateInfo);
        if (g_config.enable_bcn_decode && !g_bcn_decode_enabled) {
            LOGW("BCn interception disabled because the decoder context could not be initialized safely");
        }
...
static VKAPI_ATTR VkResult VKAPI_CALL hook_vkCreateImage(
    ...
    const VkAllocationCallbacks* pAllocator,
    VkImage* pImage) {
    auto fn = g_device_funcs.vkCreateImage;
    if (!fn) {
        fn = reinterpret_cast<PFN_vkCreateImage>(real_gdpa(device, "vkCreateImage"));
    }
    if (!fn || !pCreateInfo) {
        return VK_ERROR_INITIALIZATION_FAILED;
    }

    const bool intercept = g_bcn_decode_enabled && exynos_layer_is_bcn_format(pCreateInfo->format);
    if (intercept && !g_logged_shader_warning && should_log_shader_warning_for_format(pCreateInfo->format)) {
        LOGW("Intercepting BCn formats and translating uploads through the C++ decoder");
    ...
    if (intercept) {
        info.replacement_format = exynos_layer_replacement_format(pCreateInfo->format);
        info.storage_format = exynos_layer_storage_format(pCreateInfo->format);
        patched.format = info.storage_format;
        patched.usage |= VK_IMAGE_USAGE_STORAGE_BIT;
        if (info.replacement_format != info.storage_format) {
            patched.flags |= VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT;
        }
        info.is_bcn = 1;
    } else {
        info.replacement_format = pCreateInfo->format;
        info.storage_format = pCreateInfo->format;
        info.is_bcn = 0;
    }

    VkResult res = fn(device, &patched, pAllocator, pImage);
    if (res == VK_SUCCESS && pImage && g_image_map_initialized) {
...
static VKAPI_ATTR void VKAPI_CALL hook_vkDestroyImage(
    ...
    VkImage image,
    const VkAllocationCallbacks* pAllocator) {
    auto fn = g_device_funcs.vkDestroyImage;
    if (!fn) {
        fn = reinterpret_cast<PFN_vkDestroyImage>(real_gdpa(device, "vkDestroyImage"));
    }
    if (fn) {
        if (g_decoder_context) {
            g_decoder_context->releaseImageViews(image);
        }
        if (g_image_map_initialized) {
...
static VKAPI_ATTR void VKAPI_CALL hook_vkGetImageMemoryRequirements(
    ...
    auto fn = g_device_funcs.vkGetImageMemoryRequirements;
    if (!fn) {
        fn = reinterpret_cast<PFN_vkGetImageMemoryRequirements>(
...
static VKAPI_ATTR VkResult VKAPI_CALL hook_vkBindImageMemory(
    ...
    auto fn = g_device_funcs.vkBindImageMemory;
    if (!fn) {
        fn = reinterpret_cast<PFN_vkBindImageMemory>(real_gdpa(device, "vkBindImageMemory"));
    }
    if (!fn) {
        return VK_ERROR_INITIALIZATION_FAILED;
    }
...
static VKAPI_ATTR VkResult VKAPI_CALL hook_vkCreateImageView(
    ...
    const VkAllocationCallbacks* pAllocator,
    VkImageView* pView) {
    auto fn = g_device_funcs.vkCreateImageView;
    if (!fn) {
        fn = reinterpret_cast<PFN_vkCreateImageView>(real_gdpa(device, "vkCreateImageView"));
    }
    if (!fn || !pCreateInfo) {
        return VK_ERROR_INITIALIZATION_FAILED;
    }
    ...
    BCnImageInfo info{};
    const int is_bcn = g_image_map_initialized
        ? exynos_imap_get(&g_image_map, pCreateInfo->image, &info)
        : 0;
...
static VKAPI_ATTR void VKAPI_CALL hook_vkCmdCopyBufferToImage(
    ...
    if (try_decode_bcn_copy(commandBuffer, srcBuffer, dstImage, dstImageLayout, regionCount, pRegions)) {
        return;
    }

    PFN_vkCmdCopyBufferToImage fn = g_device_funcs.vkCmdCopyBufferToImage;
    if (fn) {
        fn(commandBuffer, srcBuffer, dstImage, dstImageLayout, regionCount, pRegions);
    }
}

static VKAPI_ATTR void VKAPI_CALL hook_vkCmdCopyBufferToImage2(
    VkCommandBuffer commandBuffer,
    ...
    if (pCopyBufferToImageInfo->regionCount == 0 || !pCopyBufferToImageInfo->pRegions) {
        auto fn = g_device_funcs.vkCmdCopyBufferToImage2;
        if (fn) {
    ...
    std::vector<VkBufferImageCopy> regions(pCopyBufferToImageInfo->regionCount);
    for (uint32_t i = 0; i < pCopyBufferToImageInfo->regionCount; ++i) {
        const auto& srcRegion = pCopyBufferToImageInfo->pRegions[i];
        VkBufferImageCopy dstRegion{};
        dstRegion.bufferOffset = srcRegion.bufferOffset;
        dstRegion.bufferRowLength = srcRegion.bufferRowLength;
        dstRegion.bufferImageHeight = srcRegion.bufferImageHeight;
        dstRegion.imageSubresource = srcRegion.imageSubresource;
        dstRegion.imageOffset = srcRegion.imageOffset;
        dstRegion.imageExtent = srcRegion.imageExtent;
        regions[i] = dstRegion;
    }

    if (try_decode_bcn_copy(commandBuffer,
...
#ifdef VK_KHR_copy_commands2
static VKAPI_ATTR void VKAPI_CALL hook_vkCmdCopyBufferToImage2KHR(
    VkCommandBuffer commandBuffer,
    ...
    if (pCopyBufferToImageInfo->regionCount == 0 || !pCopyBufferToImageInfo->pRegions) {
        auto fn = g_device_funcs.vkCmdCopyBufferToImage2KHR;
        if (fn) {
            fn(commandBuffer, pCopyBufferToImageInfo);
        }
        return;
...
static VKAPI_ATTR void VKAPI_CALL hook_vkDestroyDevice(
    VkDevice device,
    const VkAllocationCallbacks* pAllocator) {
    auto fn = g_device_funcs.vkDestroyDevice;
    if (!fn) {
        fn = reinterpret_cast<PFN_vkDestroyDevice>(real_gdpa(device, "vkDestroyDevice"));
    }

    pthread_mutex_lock(&g_layer_lock);

    shutdown_decoder_context();
    g_bcn_decode_enabled = false;

    if (g_v16_modules_init) {
        {
            uint32_t begins, ends, draws, binds;
            exynos_tfb_get_stats(&g_tfb_emulator, &begins, &ends, &draws, &binds);
            LOGI("TFB shutdown: %u begins, %u ends, %u draws, %u binds",
        ...
        if (g_vma_allocator != VK_NULL_HANDLE) {
            ...
            g_vma_allocator = VK_NULL_HANDLE;
            LOGI("AMD VMA destroyed");
        }
        {
            std::lock_guard<std::mutex> lock(g_vma_allocations_mutex);
            g_vma_allocations.clear();
        }

        g_v16_modules_init = false;
        LOGI("ExynosTools V3.1 modules shutdown complete");
    }

    if (g_image_map_initialized) {
        exynos_imap_destroy(&g_image_map);
        g_image_map_initialized = false;
    }
...
// V3.1: AMD VMA Memory Hooks
static VKAPI_ATTR VkResult VKAPI_CALL hook_vkAllocateMemory(
    VkDevice device,
    const VkMemoryAllocateInfo* pAllocateInfo,
    const VkAllocationCallbacks* pAllocator,
    VkDeviceMemory* pMemory) {
    if (g_vma_allocator != VK_NULL_HANDLE && pAllocateInfo && pMemory) {
        VmaAllocationCreateInfo vma_ci = {};
        vma_ci.usage = VMA_MEMORY_USAGE_AUTO;
        vma_ci.flags = VMA_ALLOCATION_CREATE_DEDICATED_MEMORY_BIT;
        VkMemoryRequirements reqs = {};
        reqs.size = pAllocateInfo->allocationSize;
        reqs.alignment = 1;
        reqs.memoryTypeBits = (1u << pAllocateInfo->memoryTypeIndex);
        VmaAllocation alloc = VK_NULL_HANDLE;
        VmaAllocationInfo ainfo = {};
        VkResult res = vmaAllocateDedicatedMemory(
            g_vma_allocator,
            &reqs,
            &vma_ci,
            const_cast<void*>(pAllocateInfo->pNext),
            &alloc,
            &ainfo);
        if (res == VK_SUCCESS && ainfo.deviceMemory != VK_NULL_HANDLE) {
            {
                std::lock_guard<std::mutex> lock(g_vma_allocations_mutex);
                g_vma_allocations[ainfo.deviceMemory] = alloc;
            }
            *pMemory = ainfo.deviceMemory;
            return VK_SUCCESS;
        }
    }
    auto fn = g_device_funcs.vkAllocateMemory;
...
static VKAPI_ATTR void VKAPI_CALL hook_vkFreeMemory(
    ...
    VkDeviceMemory memory,
    const VkAllocationCallbacks* pAllocator) {
    if (g_vma_allocator != VK_NULL_HANDLE && memory != VK_NULL_HANDLE) {
        VmaAllocation alloc = VK_NULL_HANDLE;
        {
            std::lock_guard<std::mutex> lock(g_vma_allocations_mutex);
            auto it = g_vma_allocations.find(memory);
            if (it != g_vma_allocations.end()) {
                alloc = it->second;
                g_vma_allocations.erase(it);
            }
        }
        if (alloc != VK_NULL_HANDLE) {
            vmaFreeMemory(g_vma_allocator, alloc);
            return;
        }
    }
    auto fn = g_device_funcs.vkFreeMemory;
    if (fn) fn(device, memory, pAllocator);
}

// V3.1: Watchdog hooks REMOVED. QueueSubmit and WaitForFences now pass through
// directly to the native driver. VK_ERROR_DEVICE_LOST is no longer masked.
static VKAPI_ATTR VkResult VKAPI_CALL hook_vkQueueSubmit(
    VkQueue queue,
    uint32_t submitCount,
    const VkSubmitInfo* pSubmits,
    VkFence fence) {
    auto fn = g_device_funcs.vkQueueSubmit;
...
static VKAPI_ATTR VkResult VKAPI_CALL hook_vkWaitForFences(
    ...
    VkBool32 waitAll,
    uint64_t timeout) {
    auto fn = g_device_funcs.vkWaitForFences;
    if (!fn) return VK_ERROR_INITIALIZATION_FAILED;
...
// V3.1: SPIR-V Patcher REMOVED. Xclipse GPUs natively support Geometry and
// Tessellation shaders. Patching was breaking OpEntryPoint and causing crashes.
static VKAPI_ATTR VkResult VKAPI_CALL hook_vkCreateShaderModule(
    VkDevice device,
    const VkShaderModuleCreateInfo* pCreateInfo,
    const VkAllocationCallbacks* pAllocator,
    VkShaderModule* pShaderModule) {
    auto fn = g_device_funcs.vkCreateShaderModule;
    if (!fn) return VK_ERROR_INITIALIZATION_FAILED;
    // Pass through directly to native driver ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â no more SPIR-V mutation
...
static VKAPI_ATTR void VKAPI_CALL hook_vkCmdDrawIndirectByteCountEXT(
    ...
    uint32_t vertexCount = exynos_tfb_get_last_vertex_count(&g_tfb_emulator);
    if (vertexCount > 0 && g_device_funcs.vkCmdDraw) {
        g_device_funcs.vkCmdDraw(commandBuffer, vertexCount, instanceCount, 0, firstInstance);
    }
}
...
static VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL hook_vkGetDeviceProcAddr(
    ...
    if (std::strcmp(pName, "vkCmdCopyBufferToImage2") == 0) return reinterpret_cast<PFN_vkVoidFunction>(hook_vkCmdCopyBufferToImage2);
#ifdef VK_KHR_copy_commands2
    if (std::strcmp(pName, "vkCmdCopyBufferToImage2KHR") == 0) return reinterpret_cast<PFN_vkVoidFunction>(hook_vkCmdCopyBufferToImage2KHR);
#endif

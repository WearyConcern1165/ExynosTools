...
// ---------------------------------------------------------------------------
BcnResult Bc5Decoder::init(VkDevice         device,
...
// ---------------------------------------------------------------------------
BcnResult Bc5Decoder::decode(const uint8_t*    compressedData,
                              uint64_t          dataSize,
                              uint32_t          texelWidth,
                              ...
                              vk::ImageWrapper* outImage)
{
    ...
    // -- 2. Create output image (R8G8_UNORM, STORAGE | SAMPLED) -------------
    VkResult res = outImage->create(
        ...
        VK_IMAGE_USAGE_STORAGE_BIT | VK_IMAGE_USAGE_SAMPLED_BIT |
            VK_IMAGE_USAGE_TRANSFER_SRC_BIT, // TRANSFER_SRC for readback tests
    ...
    pc.format = 143; // VK_FORMAT_BC5_UNORM_BLOCK = 143 exactly as in rgtc.comp for BC5
    pc.width = texelWidth;
